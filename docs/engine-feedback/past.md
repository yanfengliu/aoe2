...
**Moved 2026-09-10 (freshness audit).** Neither is an ask: the first is an adoption note that says so in its own words, the second says RESOLVED and adopted. Engine is at 2.4.1 and its changelog head is 2.4.1 (2026-07-10), so no ask in `current.md` has been answered by a newer engine — these two were retired for being history, not for being addressed.
