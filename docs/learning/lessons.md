...
Pointer: [src/game/simulation/bridge/bridgeState.ts](../../src/game/simulation/bridge/bridgeState.ts) (`movePathCache` field), [src/game/simulation/bridge/bridgeHelpers.ts](../../src/game/simulation/bridge/bridgeHelpers.ts) (`clearUnitCommand`, `setUnitCommand`), [src/game/simulation/bridge/movementPlanOps.ts](../../src/game/simulation/bridge/movementPlanOps.ts) (`resolveMovePlanFromCache`); [tests/simulation/movementPathCaching.test.ts](../../tests/simulation/movementPathCaching.test.ts).
