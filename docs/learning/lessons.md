...
- A gate's THRESHOLD and the message explaining it are two artifacts; the threshold can stay right while the message goes stale and misdirects the next reader ([evidence](lessons-evidence.md#a-gates-threshold-and-the-message-explaining-it-are-two-artifacts-2026-09-01))
- A probe that reconstructs game state from guessed field names or eyeballed screen coordinates is a hypothesis about the schema, not a measurement of the game ([evidence](lessons-evidence.md#a-probe-that-reconstructs-game-state-from-guessed-field-names-is-a-hypothesis-2026-09-01))
