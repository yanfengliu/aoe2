...
| Field | Value |
|---|---|
| Surfaced by | Full-codebase review iter-1, Claude persistence lens (H1); `docs/threads/current/full/2026-07-10/1/REVIEW.md`. The reviewer ran a 7-auditor `markDirty` sweep that converged on exactly the two wildlife sites. |
