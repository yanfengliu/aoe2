...
Pointer: [src/game/simulation/selectionActivity.ts](../../src/game/simulation/selectionActivity.ts) (`computeUnitActivity`), [src/ui/hud/selectionPanel/render.ts](../../src/ui/hud/selectionPanel/render.ts) (`formatActivityLabel`).
...
Pointer: [src/game/simulation/worldOccupancy.ts](../../src/game/simulation/worldOccupancy.ts), [src/game/simulation/bridge/createWorld.ts](../../src/game/simulation/bridge/createWorld.ts) (occupancy wiring), [tests/simulation/worldOccupancy.test.ts](../../tests/simulation/worldOccupancy.test.ts).
...
Pointer: [src/game/simulation/bridge/bridgeState.ts](../../src/game/simulation/bridge/bridgeState.ts) `movePathCache`, [src/game/simulation/bridge/bridgeHelpers.ts](../../src/game/simulation/bridge/bridgeHelpers.ts) `clearUnitCommand`/`setUnitCommand`, [src/game/simulation/bridge/movementPlanOps.ts](../../src/game/simulation/bridge/movementPlanOps.ts) `resolveMovePlanFromCache`; [tests/simulation/movementPathCaching.test.ts](../../tests/simulation/movementPathCaching.test.ts).
