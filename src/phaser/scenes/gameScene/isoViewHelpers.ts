// Pure isometric view/camera math extracted from GameScene so the scene stays
// under its size budget and the geometry is unit-testable without a Phaser
// stage. Every function is a pure function of its inputs (no `this`, no camera
// object) — the scene passes in the small primitives each one needs.

import type { ProjectedEntityView } from '../../../game/simulation/types';
import { doesIsoWorldRectIntersectEntity } from '../entityHitTest';
...
// clipped. Used for the Phaser camera bounds.
