...
const UNIT_ATTACK_RIGS = {
  ...
  'elite-jaguar-warrior': SWORD_RIG,
  'cataphract': MOUNTED_SWORD_RIG,
  'elite-cataphract': MOUNTED_SWORD_RIG,
  'woad-raider': SWORD_RIG,
  'elite-woad-raider': SWORD_RIG,
  'chu-ko-nu': CROSSBOW_RIG,
  'elite-chu-ko-nu': CROSSBOW_RIG,
  'throwing-axeman': JAVELIN_RIG,
  'elite-throwing-axeman': JAVELIN_RIG,
  'huskarl': SWORD_RIG,
  'elite-huskarl': SWORD_RIG,
  'tarkan': MOUNTED_SWORD_RIG,
  'elite-tarkan': MOUNTED_SWORD_RIG,
  'samurai': SWORD_RIG,
  'elite-samurai': SWORD_RIG,
  'war-wagon': MOUNTED_BOW_RIG,
  'elite-war-wagon': MOUNTED_BOW_RIG,
  'plumed-archer': BOW_RIG,
  'elite-plumed-archer': BOW_RIG,
  'mangudai': MOUNTED_BOW_RIG,
  'elite-mangudai': MOUNTED_BOW_RIG,
  'war-elephant': LANCE_RIG,
  'elite-war-elephant': LANCE_RIG,
  'mameluke': MOUNTED_BOW_RIG,
  'elite-mameluke': MOUNTED_BOW_RIG,
  'conquistador': MOUNTED_GUN_RIG,
  'elite-conquistador': MOUNTED_GUN_RIG,
  'teutonic-knight': SWORD_RIG,
  'elite-teutonic-knight': SWORD_RIG,
  'janissary': HAND_CANNON_RIG,
  'elite-janissary': HAND_CANNON_RIG,
  'berserk': GREATSWORD_RIG,
  'elite-berserk': GREATSWORD_RIG,
  'turtle-ship': MONK_RIG,
  'elite-turtle-ship': MONK_RIG,
  'longboat': MONK_RIG,
  'elite-longboat': MONK_RIG,
