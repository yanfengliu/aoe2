...
import { TRAINING_COSTS } from './trainingCosts';
...
const TRAINING_TIME_TICKS: Record<TrainableUnitType, number> = {
  ...
  archer: 350,
  skirmisher: 260,
  'elite-skirmisher': 220,
  'eagle-warrior': 350,
  'elite-eagle-warrior': 200,
  'hand-cannoneer': 340,
  knight: 300,
  crossbowman: 270,
  pikeman: 220,
  ...
  halberdier: 220,
  hussar: 300,
  'heavy-cavalry-archer': 300,
  cavalier: 300,
  champion: 210,
  'elite-longbowman': 180,
  onager: 460,
  'siege-onager': 460,
  'heavy-scorpion': 300,
  'siege-ram': 360,
  ...
  'trade-cart': 510, // units.csv 51 s x 10 TPS.
  'trade-cog': 360, // units.csv 36 s x 10 TPS.
  missionary: 510, // units.csv 51 s x 10 TPS.
  'fishing-ship': 400,
  'transport-ship': 460, // units.csv: 46 s x 10 TPS.
  galley: 450,
  'war-galley': 270,
  galleon: 270,
  'fire-ship': 270,
  ...
  'turtle-ship': 500,
  'longboat': 250,
  'elite-jaguar-warrior': 120,
  'elite-cataphract': 200,
  'elite-woad-raider': 100,
  'elite-chu-ko-nu': 130,
  'elite-throwing-axeman': 130,
  'elite-huskarl': 130,
  'elite-tarkan': 140,
  'elite-samurai': 90,
  'elite-war-wagon': 210,
