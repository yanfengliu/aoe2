...
// `src/game/simulation/bridge/systems/aiSystem.ts` (registered under the ECS
// name `prototypeAi`); this file carries the pure helpers (plan selection,
// unit mixes, difficulty multipliers) so the system body stays readable.
//
