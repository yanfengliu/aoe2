// MockProvider: feeds canned LlmCallResult responses for tests.
// The mock estimates token counts by character heuristic if not
// supplied — close enough for cost-budget assertions in unit tests.
