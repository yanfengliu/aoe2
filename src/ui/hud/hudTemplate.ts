      ...
      <div class="hud-game-menu" data-hud="game-menu" role="dialog" aria-modal="true" aria-label="Game menu" hidden>
        ...
        <div class="hud-game-menu__panel">
          ...
          <div class="hud-game-menu__section">
            ...
            <button type="button" class="hud-menu-item hud-menu-item--toggle" data-hud="menu-art-style-cycle" aria-label="Art style: Moebius" data-tooltip="Art style — switch between ink contours over flat colour and plain voxel shading.">
