      ...
      <div class="hud-game-menu" data-hud="game-menu" role="dialog" aria-modal="true" aria-label="Game menu" hidden>
        ...
        <div class="hud-game-menu__panel">
          ...
          <div class="hud-game-menu__actions">
            ...
            <button type="button" class="hud-menu-item" data-hud="menu-civilizations" aria-label="Civilizations" data-tooltip="Civilizations — compare all thirty side by side: army type, unique unit, team bonus and every civilization bonus.">${gameMenuGlyph('civilizations')}</button>
