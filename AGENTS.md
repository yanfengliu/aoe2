...
- Use Codex code reviewer subagents to review every change on the following aspect(s), in seris:
  - Design
    - Can easily scale, generalize, debug, be understood and reasoned about, and stay lean
  - Test coverage
  - Correctness
  - Clean code, efficiency, memory leaks
...
- Each round of review should be done by a new subagent in series
