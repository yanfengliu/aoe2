...
const WEAPONS = {
  ...
  'elite-skirmisher': { kind: 'javelin', parts: ['archer-javelin-shaft', 'archer-javelin-head'] },
  'eagle-warrior': { kind: 'sword', parts: ['infantry-sword', 'infantry-sword-hilt'] },
  'elite-eagle-warrior': { kind: 'sword', parts: ['infantry-sword', 'infantry-sword-hilt'] },
  'hand-cannoneer': { kind: 'hand-cannon', parts: ['archer-cannon-stock', 'archer-cannon-barrel', 'archer-cannon-muzzle'] },
  ...
  'siege-onager': { kind: 'stone-thrower', parts: ['siege-throwing-arm', 'siege-bucket'] },
