...
// ground to draw, an unchanged frame uploads nothing, each tier is its own program, and the shader splices into
// Three's own Lambert program, failing by name if Three's chunks move. What the shader DRAWS is tests/browser/de-ground.spec.ts's.
