...
//
//
// F5 and F6 are FIXED too (v0.3.189, the command-deck rework):
//   F5 FIXED in v0.3.189. Was: at this suite's 800x600 the command deck
...
//   F6 FIXED in v0.3.189. Was: a clicked command card kept keyboard focus
...
// order (v0.3.189; `readBuildPanel` visits both tabs).
