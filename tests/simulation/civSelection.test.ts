...
describe('civilizationsByOwner — overrides the scenario start civ end-to-end', () => {
  it('a ?civ=Goths override lets owner 1 train the discounted (Goths) Militia', () => {
    // The control fixture is Persians with 45 food / 18 gold — it CANNOT afford
    // the base Militia (50/20). Overriding owner 1 to Goths applies the −35%
    // infantry discount, so the Feudal Militia (40/16) becomes affordable and is charged.
