...
- the selection panel to place Barracks in Dark Age, then Archery Ranges and Blacksmiths in Feudal Age, and queue Militia or Archers from completed military buildings
...
- for deterministic test fixtures, the dev server also accepts `?seed=conquest-victory-fixture`, `?seed=conquest-defeat-fixture`, `?seed=feudal-missing-prereq-fixture`, `?seed=feudal-age-fixture`, and `?seed=feudal-blacksmith-fixture`
