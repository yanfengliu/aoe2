...
**Gatherer distribution — food-priority for age-ups (implemented).** The AI spreads its villagers across resources by an age-keyed target weight map: Dark {food 4, wood 3}, Feudal {food 7, wood 4, gold 1}, Castle {food 4, wood 4, gold 3, stone 1}, Imperial {food 4, wood 3, gold 5, stone 1}. Feudal is deliberately food-dominant because the Castle age-up costs 800 food to only 200 gold (4:1). Grounded by replaying an AI-vs-AI match: an earlier Feudal split of {food 5, wood 4, gold 2} left the AI mining gold it barely spent (hoarding ~1500) while its food stayed pinned near zero, so it never gathered the 800 food to advance — the gold sink in Feudal is only the archer (45 gold) plus the Castle's own 200 gold, both of which one gold villager funds comfortably. Weighting food far above gold in Feudal is the supply-side half of reliably reaching Castle Age; the demand-side complement — having villager training also respect the age-up reserve so the banked food is not immediately re-spent on more villagers — is tracked as the next increment.
