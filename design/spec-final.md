...
Lines the seams cannot express yet are the open remainder, not silently dropped — the largest families: free technologies (Aztecs Loom, Byzantines Town Watch, Turks Chemistry, Vikings carts, Koreans tower upgrades, Magyars forging line, and more), starting-resource and starting-unit deltas (Chinese, Mayans, Persians, Huns, Incas' llama), age-scaled HP (Vikings and Vietnamese, Byzantine buildings), carry-capacity bonuses (Aztecs +5, Goths hunters), building-cost and building-stat bonuses (Franks castles, Teutons farms and towers, Japanese economy buildings, Persians TC/Dock HP, Incas and Malians building materials), and one-off mechanics (Huns houseless population, Khmer prerequisites, Incas' Eagle line swap, Vietnamese reveal). Each lands when its seam does.
