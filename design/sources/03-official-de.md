...
- the DE-targeted spec needed an official source for civilization identity and tech-tree semantics instead of relying on older AoC-only assumptions
...
- confirming that AoE2 DE was still receiving new civilizations and technologies as of `February 17, 2026`
